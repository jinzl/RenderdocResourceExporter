...
class FbxExportOptionDialogConstMapper:
    ...
    text_cn = {
        ...
        c_export_binormal : '导出副切线',
        c_export_uv : '导出 UV',
        c_export_uv2 : '导出 UV2',
        c_export_uv3 : '导出 UV3',
        c_export_color : '导出顶点色',
    }
